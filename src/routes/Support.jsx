...
import { Search, Bell, Menu, X, Send, User, MessageSquare, RefreshCw, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-white">Tranchi</h1>
              <p className="text-gray-300 text-sm mt-2">Get help with your applications and account</p>
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className={`text-xs mt-1 ${
                      msg.senderType === 'User' ? 'text-gray-200' : 'text-gray-400'
                    }`}>
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div className="bg-gray-700/80 text-white px-4 py-2 rounded-lg border border-gray-600">
                  <div className="text-sm text-gray-300 italic">Support team is typing...</div>
                </div>
              </div>
            )}
